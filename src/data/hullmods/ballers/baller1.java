...
/*
    ...
    BALLIIIIIIIIIIIIIIIIIIIIIIIIIIIIIING
 ...
 */
public class baller1 extends BaseHullMod {


    private String getString(String key) {
        return Global.getSettings().getString("der", key);
    }
    public static final float BigProblemo = 20f; // Damage taken %
    public static final float moarfluxtsussy = 10f; // more flux overall %
    public static final float shieldophaso = 20f; // shield eff and phase cost. Phase cost count like this = shiledophaso / 2f
    public static final float xivspiritsupport = 15f; // speed and turn %
    public static final float gayso = 12.5f; // i don't rememeber
    ...
    public String getUnapplicableReason(ShipAPI ship) {
        ...
        for(String hullmod:ship.getVariant().getHullMods()){
            if(Global.getSettings().getHullModSpec(hullmod).hasTag("ballerinc") && !hullmod.equals("dermondballer1")){
                hasai = true;
            }
        }
